...
const MembersBenefits = () => {
    ...
    return ( <section className="flex flex-col w-full relative" ref={containerRef}>
        <div className="relative  w-full h-[240vh] bg-[#B0DAED]  rounded-t-[40px]">
<img src={'/assets/images/leftTree.png'} className="absolute left-0 bottom-40  h-[1132px]  "  alt=''/>
<img src={'/assets/images/rightTree.png'} className="absolute right-0 bottom-0  h-[1395px] "  alt=''/>
