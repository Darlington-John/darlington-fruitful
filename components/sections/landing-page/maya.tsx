...
<h1 className="font-semibold  text-[77px] leading-[77px]  text-center  xl:text-5xl  xs:text-3xl 2xs:text-2xl  4xl:text-[88px]  4xl:leading-[88px]" style={float} ref={ref}>“More than just feeling less <br className="md:hidden"  />
