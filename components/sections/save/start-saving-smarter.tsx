...
savings.`,
  ...
  const registerCardRef = (ref, id) => {
    ...
    return (<div className="flex items-start  px-[208px]   relative  py-40  gap-96  2xl:gap-0  2xl:justify-between  xl:px-20   sm:px-6 4xl:justify-between" ref={glowRef3}  style={glow}>
