...
const GrowWithGuide = () => {
    ...
    return (  
    <section className="h-screen w-full  flex  items-center justify-between px-[66px]  gap-20  lg:flex-col  lg:pt-40  l  lg:gap-4  lg:h-full  md:pt-28 md:pt-20 xs:pt-16 md:px-8   xs:px-4">
