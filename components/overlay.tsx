...
const Overlay = () => {
  ...
  return (
    <div className=" hidden h-[0px] w-full fixed z-40 top-0 right-0 bg-white    md:flex      flex-col gap-16 justify-end  fade ease-out duration-[0.5s]   " id="myOverlay">
      ...
      <div className={`flex gap-2 flex-col  ${isOverlayOpen? '':'opacity-0'}`}>
 ...
 <div className={`flex flex-col gap-4 fade  ${isOverlayOpen? '':'opacity-0'}`}>
...
Sign up
 ...
 <div className='grid grid-cols-2 leading-none gap-y-10 pb-20'>
  <div className='flex flex-col gap-2 items-start xs:text-sm '>
<h1>hello</h1>
<h1>hello</h1>
</div>
<div className='flex flex-col gap-2 items-start xs:text-sm'>
